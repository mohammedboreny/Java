...
//        return result;
     ...
     * @return new Expanded Array y
     * @param <U>
     *
     *     flatMap() = map() + flattening
     *     I tried to flatten the array after mapping on it but i couldn't access the second diminsion to be able
...
//t->u->v
    ...
    interface CBIFunction<T, U, V> extends Function<T, Function<U, V>> {
    }
    ;
